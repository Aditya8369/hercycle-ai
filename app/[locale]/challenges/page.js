...
//   if (!data) return <div className="page"><Navbar /><main className="pt-10 text-center text-white/70">{t('loading')}</main></div>
...
//         <header>
//           <h1 className="text-3xl sm:text-4xl font-bold text-white drop-shadow-md">🌸 {t('title')}</h1>
//         </header>

//         {data.badges.length > 0 && (
//           <section className="glass rounded-3xl p-5">
//             <h2 className="text-white/90 font-semibold mb-3">{t('yourBadges')}</h2>
//             <div className="flex flex-wrap gap-3">
//               {data.badges.map((b) => (
//                 <span key={b.badge_key} className="px-3 py-1.5 rounded-full bg-white/10 text-white text-sm flex items-center gap-1.5">
//                   {BADGES[b.badge_key]?.icon} {BADGES[b.badge_key]?.label}
//                 </span>
//               ))}
//             </div>
//           </section>
...
//               <h3 className="text-white text-xl font-bold">{t('badgeEarned')}</h3>
//               <p className="text-white/70 mt-1">{BADGES[newBadge]?.label}</p>
//             </div>
//           </div>
//         )}
//       </main>
