...
export default function ConfirmationModal({
  ...
  const isMatched = inputValue.trim() === keyword
  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={handleOpenChange}>
      <Dialog.Portal>
        <Dialog.Overlay className="fixed inset-0 bg-black/70 backdrop-blur-md z-50 transition-opacity animate-in fade-in-0 duration-200" />
        <Dialog.Content className="fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-[#1a1a2e]/95 text-white rounded-3xl p-6 sm:p-8 w-[92vw] max-w-md shadow-2xl z-50 border border-red-500/20 focus:outline-none animate-in zoom-in-95 duration-200">
