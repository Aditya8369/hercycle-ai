...
//   // When requireKeyword is false, confirm is enabled immediately — for
//   // lower-stakes actions that still want a confirm/cancel step but
//   // shouldn't force the user to type anything (e.g. clearing a
//   // notification feed, versus permanently deleting an account).
...
//         />
//         <Dialog.Content
//           className="fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-[#1a1a2e]/95 text-white rounded-3xl p-6 sm:p-8 w-[92vw] max-w-md shadow-2xl border border-red-500/20 focus:outline-none animate-in zoom-in-95 duration-200"
//           style={{ zIndex: 99999 }}
//         >
//           {/* Header */}
//           <div className="flex justify-between items-start mb-5">
//             <Dialog.Title className="text-xl sm:text-2xl font-bold flex items-center gap-2 text-red-400">
...
//             {/* Warning Callout Box */}
//             <Dialog.Description className="bg-red-500/10 border border-red-500/20 p-4 rounded-2xl text-sm text-red-200/90 leading-relaxed">
//               {description}
//             </Dialog.Description>

//                         {/* Keyword Instruction & Input — only shown when confirmation
//                 requires typing a keyword */}
//             {requireKeyword && (
